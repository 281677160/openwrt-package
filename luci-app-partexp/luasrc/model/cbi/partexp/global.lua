...
translate( "Automatically format and mount the target device partition. If there are multiple partitions, it is recommended to manually delete all partitions before using this tool.<br/>") ..translate("<a href=\'' target=\'_blank\'>GitHub @sirpdboy</a>") )
